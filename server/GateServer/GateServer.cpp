...
void TestRedisMgr() {
  assert(RedisMgr::GetInstance()->Set("blogwebsite", "TeamChat.club"));
  std::string value = "";
  assert(RedisMgr::GetInstance()->Get("blogwebsite", value));
  assert(RedisMgr::GetInstance()->Get("nonekey", value) == false);
  assert(RedisMgr::GetInstance()->HSet("bloginfo", "blogwebsite",
                                       "TeamChat.club"));
...
void TestMysqlMgr() {
  int id = MysqlMgr::GetInstance()->RegUser("wwc", "secondtonone1@163.com",
                                            "123456", ": / res / head_1.jpg");
